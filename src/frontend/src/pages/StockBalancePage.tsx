      ...
      <Card className="hc-inventory-filter-panel" padding="md">
        <div className="hc-inventory-filter-panel__top">
          <div>
            ...
            <p className="hc-inventory-filter-panel__description">Search by item or warehouse, then narrow the ledger slice that contributes to the displayed balance.</p>
          </div>
